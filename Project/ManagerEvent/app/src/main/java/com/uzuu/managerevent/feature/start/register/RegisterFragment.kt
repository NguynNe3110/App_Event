...
import com.uzuu.managerevent.databinding.FragmentRegisterBinding
import com.uzuu.managerevent.feature.MainActivity
    ...
    private fun setupEvent() {
        binding.btnRegister.setOnClickListener {
            viewModel.onClickRegister(
                ...
                binding.edtEmail.toString().trim(),
                binding.edtFullName.toString().trim(),
                binding.edtPhoneNumber.toString().trim(),
                binding.edtAddress.toString().trim()
            )
        }
    }
}