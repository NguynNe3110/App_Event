package com.uzuu.learn19_4_practice_nav_isolation.ui.adapter
...
class ListAdapterBasic(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.binding.productPrice.text = item.price.trim()
